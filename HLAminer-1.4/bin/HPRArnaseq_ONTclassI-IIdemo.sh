...
/usr/bin/time -v -o minimap_hlaminerRNASEQont_CDS.time minimap2 -t 48 -ax map-ont --MD GCA_000001405.15_GRCh38_genomic.chr-only-noChr6-HLA-I_II_CDS.fa.gz $1 | ../bin/HLAminer.pl -h ../database/HLA-I_II_CDS.fasta -s 500 -q 1 -i 1 -p ../database/hla_nom_p.txt -a stream
