...
#LICENSE
#   HLAminer Copyright  (c) 2011-2015 Canada's Michael Smith Genome Science Centre.  All rights reserved.
#   TASR Copyright   (c) 2010-2015 Canada's Michael Smith Genome Science Centre.  All rights reserved.
#   SSAKE Copyright  (c) 2006-2015 Canada's Michael Smith Genome Science Centre.  All rights reserved.
#   
...
if($opt_a ne ""){
   ...
   $top_hits = readSam($sam_file,$min_tig_size,$column,0,$singleend);
...
sub readSam{
   ...
   my ($file,$min,$column,$reci,$singleend) = @_;
