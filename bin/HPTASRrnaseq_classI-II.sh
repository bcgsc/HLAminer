...
../bin/TASR -f patient.fof -m 20 -s ../database/HLA-I_II_CDS.fasta -i 1 -b TASRhla
...
../bin/parseXMLblast.pl -c ncbiBlastConfig.txt -d ../database/HLA-I_II_CDS.fasta -i TASRhla200.contigs -o 0 > tig_vs_hla-ncbi.coord
